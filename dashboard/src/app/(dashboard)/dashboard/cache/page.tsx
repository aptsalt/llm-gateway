  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-1 text-zinc-400">Monitor your semantic cache performance</p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card className="bg-zinc-900 border-zinc-800">
          <CardHeader>
            <div className="flex items-center justify-between">
              <CardDescription className="text-zinc-400">Hit Rate</CardDescription>
              <TrendingUp className="h-4 w-4 text-blue-500" />
            </div>
            <CardTitle className="text-2xl">68.2%</CardTitle>
            <p className="text-xs text-zinc-400">4,250 hits / 6,230 requests</p>
          </CardHeader>
        </Card>
        ...
        <Card className="bg-zinc-900 border-zinc-800">
          <CardHeader>
            <div className="flex items-center justify-between">
              <CardDescription className="text-zinc-400">Miss Rate</CardDescription>
              <Database className="h-4 w-4 text-blue-500" />
            </div>
            <CardTitle className="text-2xl">31.8%</CardTitle>
            <p className="text-xs text-zinc-400">1,980 misses</p>
          </CardHeader>
        </Card>
        ...
        <Card className="bg-zinc-900 border-zinc-800">
          <CardHeader>
            <div className="flex items-center justify-between">
              <CardDescription className="text-zinc-400">Total Entries</CardDescription>
              <Database className="h-4 w-4 text-blue-500" />
            </div>
            <CardTitle className="text-2xl">4,250</CardTitle>
            <p className="text-xs text-zinc-400">Cached responses</p>
          </CardHeader>
        </Card>
      </div>
      ...
      <Card className="bg-zinc-900 border-zinc-800">
        ...
        <div className="grid gap-4 p-6 md:grid-cols-4">
          <div>
            ...
            <p className="text-xs text-zinc-500">4,250 cached requests</p>
          </div>
          <div>
            <p className="text-sm text-zinc-400">This Month</p>
            <p className="text-2xl font-bold text-green-500">$58.40</p>
            <p className="text-xs text-zinc-500">18,900 cached requests</p>
          </div>
          <div>
            <p className="text-sm text-zinc-400">All Time</p>
            <p className="text-2xl font-bold text-green-500">$142.80</p>
            <p className="text-xs text-zinc-500">45,200 cached requests</p>
          </div>
          <div>
            <p className="text-sm text-zinc-400">Avg per Request</p>
            <p className="text-2xl font-bold">$0.0032</p>
            <p className="text-xs text-zinc-500">Cost avoided</p>
          </div>
        </div>
      </Card>
        ...
        <div className="p-6 space-y-4">
          <div className="flex items-center justify-between rounded-lg border border-zinc-800 p-4">
            <div>
              ...
              <p className="text-xs text-zinc-500">0.95 (95% similarity required)</p>
            </div>
            <span className="text-sm text-zinc-400">Configured in gateway</span>
          </div>

          <div className="flex items-center justify-between rounded-lg border border-zinc-800 p-4">
            <div>
              <p className="text-sm font-medium">TTL (Time to Live)</p>
              <p className="text-xs text-zinc-500">24 hours</p>
            </div>
            <span className="text-sm text-zinc-400">Configured in Redis</span>
          </div>

          <div className="flex items-center justify-between rounded-lg border border-zinc-800 p-4">
            <div>
              <p className="text-sm font-medium">Vector Database</p>
              <p className="text-xs text-zinc-500">Redis with vector search</p>
            </div>
          ...
          <div className="flex items-center justify-between rounded-lg border border-zinc-800 p-4">
            <div>
              ...
              <p className="text-xs text-zinc-500">text-embedding-3-small (OpenAI)</p>
            </div>
            <span className="text-sm text-zinc-400">1536 dimensions</span>
          </div>
        </div>
      </Card>
